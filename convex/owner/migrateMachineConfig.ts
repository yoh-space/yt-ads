...
export const migrateMachineConfig = mutation({
  ...
  handler: async (ctx) => {
    ...
    const SERVICE_LABELS: Record<string, { en: string; am: string; category: string; sortOrder: number }> = {
      ...
      foam_cutout: { en: "Foam Cut-out", am: "ፎም ቁረጥ", category: "CNC_AND_LASER", sortOrder: 17 },
      foam_engrave: { en: "Foam Engrave", am: "ፎም ማስቀርታ", category: "CNC_AND_LASER", sortOrder: 18 },
      mica_cutout: { en: "Mica Cut-out", am: "ሚካ ቁረጥ", category: "CNC_AND_LASER", sortOrder: 19 },
      mica_engrave: { en: "Mica Engrave", am: "ሚካ ማስቀርታ", category: "CNC_AND_LASER", sortOrder: 20 },
