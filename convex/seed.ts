...
const SERVICE_DEFINITIONS_SEED = [
  ...
  { serviceKey: "foam_cutout", categoryKey: "CNC_AND_LASER", nameEn: "Foam Cut-out", nameAm: "ፎም ከት", sortOrder: 17 },
  { serviceKey: "foam_engrave", categoryKey: "CNC_AND_LASER", nameEn: "Foam Engrave", nameAm: "ፎም ኢንግሬቭ", sortOrder: 18 },
  { serviceKey: "mica_cutout", categoryKey: "CNC_AND_LASER", nameEn: "Mica Cut-out", nameAm: "ሚካ ከት", sortOrder: 19 },
  { serviceKey: "mica_engrave", categoryKey: "CNC_AND_LASER", nameEn: "Mica Engrave", nameAm: "ሚካ ኢንግሬቭ", sortOrder: 20 },
