...
export default defineSchema({
  companySettings: defineTable({
    ...
    notificationPreferences: v.optional(v.object({
      inventoryInApp: v.boolean(),
      inventoryEmail: v.boolean(),
      inventoryTelegram: v.boolean(),
      approvalsInApp: v.boolean(),
      approvalsEmail: v.boolean(),
      approvalsTelegram: v.boolean(),
      reconciliationInApp: v.boolean(),
      reconciliationEmail: v.boolean(),
      reconciliationTelegram: v.boolean(),
      financialInApp: v.boolean(),
