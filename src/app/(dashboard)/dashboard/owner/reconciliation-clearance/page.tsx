...
import { Scale, Hourglass, TrendingDown, TrendingUp, Search, X, Check } from "lucide-react";
...
export default function OwnerReconciliationClearancePage() {
  ...
  const resolve = useMutation(api.reconciliation.review);
  ...
  async function handleAccept() {
    ...
    setResolving(true);
    try {
      await resolve({ reconciliationId: selected.id as any, status: "Accepted" });
  ...
  async function handleResolve() {
    ...
    setResolving(true);
    try {
      await resolve({ reconciliationId: selected.id as any, status: "Resolved", note: resolveNote.trim() });
