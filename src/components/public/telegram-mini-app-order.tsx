...
const DIMENSION_PRESETS = [
  { label: "1m × 1m", value: "1x1" },
  { label: "1.5m × 2m", value: "1.5x2" },
  { label: "2m × 3m", value: "2x3" },
  { label: "3m × 5m", value: "3x5" },
  { label: "A1 (LightBox)", value: "0.594x0.841" },
  { label: "RollUp 85×200", value: "0.85x2" },
];
...
export function TelegramMiniAppOrder() {
  ...
  return (
    <div className="min-h-screen bg-[#0C0D10] text-[#D4D4D4] font-sans antialiased pb-28">
      ...
      {/* ── Main Form ─────────────────────────────────────────────── */}
      <form onSubmit={submit} className="p-4 space-y-5 max-w-xl mx-auto">
        ...
        <section className="bg-[#131418] border border-white/[0.08] rounded-sm p-4 space-y-3.5">
          ...
          <div className="grid grid-cols-3 gap-2.5 pt-1">
            <div className="col-span-2 space-y-1">
              <span className="font-mono text-[10px] uppercase tracking-wider text-neutral-400 block">መጠን (ርዝመት x ጎን)</span>
              <input
                required
        ...
        <div className="fixed bottom-0 left-0 right-0 p-3 bg-[#0C0D10]/95 backdrop-blur-md border-t border-white/[0.08] z-50">
