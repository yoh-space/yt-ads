    ...
    <aside className="animate-slide-in-right relative flex h-full w-full max-w-lg flex-col border-l border-border bg-card shadow-2xl">
      ...
      <div className="flex-1 space-y-5 overflow-y-auto p-5">
        {!editing ? <>
          ...
          <div className="rounded-xl border border-primary/20 bg-primary/5 p-3 text-[11px] text-muted-foreground">{member.assigned === false ? "Choose a role to assign this staff member. Machine operators can then be limited to compatible machines." : "Changes apply immediately to this staff account."}</div>
