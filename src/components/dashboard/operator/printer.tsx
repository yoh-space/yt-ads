  ...
  return (
    ...
    >
      ...
      <div className="operator-form-grid">
        <label>Print area (m²)<NumericInput min={0} step="0.1" value={area} onChange={setArea} /></label>
      ...
      <div className="control-readout"><Printer size={17} /><span>Media feed estimate</span><b>{(Number(area) / 3.2).toFixed(1)} m</b></div>
    </OperatorWorkspaceShell>
  );
}
